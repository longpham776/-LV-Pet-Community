...
<html lang="en">
  ...
  <body>
  <i class="fas fa-h2">Chào bạn, bạn đã đăng ký tài khoản ở trang của chúng tôi</i>
    ...
    <div class="row">
        <div class="col-sm-2" style="background-color:lavender;"><b>vui lòng nhấp liên kết dưới để kích hoạt tài khoản:</b></div>
        <div class="col-sm-8" style="background-color:lavenderblush;">
        <a href="{{route('activeLogin',['email'=>$thongtin[0]->email, 'token'=>$thongtin[0]->token])}}">Active</a>
